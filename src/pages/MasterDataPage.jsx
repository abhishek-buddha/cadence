...
export default function MasterDataPage() {
  ...
  return (
    <div className="space-y-6 animate-fade-in">
      <div>
        <h1 className="text-2xl font-display font-bold text-gray-900 tracking-tight">Master Data</h1>
        <p className="text-sm text-muted mt-1">Patients, insurance, and provider records</p>
      </div>
