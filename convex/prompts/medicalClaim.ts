...
Exception: when call_connection_type is exactly "ivr_only_cut_at_handoff", the CALL ROUTING MODE check at the top of the operating-mode section applies instead — call end_call with reason exactly "ivr_cut_before_human_reached" at the human-handoff point, even when a bridge number is configured.
